...
(** An environment is used to map De Bruijn indices to objects (or nothing).
    ...
    This is low level and should be used with a lot of care (it's mostly used in {!InnerTerm.DB} and a lot of
    coffee or aspiring at hand. *)
...
(** [mem env i] returns [true] iff [find env i] returns [Some _] rather than [None], ie. whether the [i]-th De
    Bruijn variable is bound within [env] *)
