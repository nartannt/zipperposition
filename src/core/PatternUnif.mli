...
(** This module implements pattern unification oracle described in
    {{:http://matryoshka.gforge.inria.fr/pubs/hounif_paper.pdf} the HOUnif paper}. It can be applied to terms out
    of the pattern fragment in which case it raises NotInFragment exception. *)
